...
const ProfileCreateForm: React.FC<ProfileFormType> = ({
  ...
  const title = initialData ? 'Editar perfil' : 'Criar Perfil';
  const description = initialData
    ? 'Edite seu perfil.'
    : 'Para criar seu perfil, precisamos de algumas informações básicas sobre você.';
  const toastMessage = initialData ? 'Perfil atualizado.' : 'Perfil criado.';
                      ...
                      <AccordionContent>
                        ...
                        >
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel>País do trabalho</FormLabel>
                                <Select
                                  disabled={loading}
                                  onValueChange={field.onChange}
                                  value={field.value}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel>Cidade do trabalho</FormLabel>
                                <Select
                                  disabled={loading}
                                  onValueChange={field.onChange}
                                  value={field.value}
